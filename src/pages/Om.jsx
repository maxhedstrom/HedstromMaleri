...
const TeamMember = ({ person }) => {
  ...
  return (
    <div className="bg-white shadow-lg rounded-lg overflow-hidden flex flex-col relative h-[750px]">
      ...
      >
        {/* Expanderad overlay – täcker halva bilden */}
        <div
        ...
        {/* Pilknapp placerad mellan bild och info (höger sida) */}
        <button
      ...
      {/* Informationsruta med röd bakgrund */}
  ...
  const teamMembers = [
    {
      ...
      description: "Peter har över 30 års erfarenhet av måleri och grundade företaget 2011. Han är passionerad om kvalitet och kundnöjdhet.",
    },
    {
      name: "Anton Hedström",
      ...
      description: "Anton kombinerar moderna metoder med traditionellt hantverk. Han ansvarar för projektledning och ser till att kvalitetsstandarder hålls.",
    },
    {
      ...
      description: "Ulrika hanterar administrationen och ser till att alla projekt löper smidigt. Hon är hjärtat i vår kundkontakt.",
    },
      ...
      <div className="mt-[5%] flex flex-col md:flex-row px-4 md:px-40 justify-between items-stretch">
        ...
        <div className="basis-full md:basis-[55%] min-h-[400px] h-full rounded-[10px] py-5 px-3 hover:shadow-[0_0_20px_0_rgba(0,0,0,0.2)] text-center md:text-left flex flex-col justify-center">
          ...
          <p className="text-gray-500 text-sm md:text-base leading-relaxed">
            Hedström Måleri AB är ett familjeföretag med gedigen erfarenhet och ett starkt fokus på kundnöjdhet. Företaget grundades 2011 av Peter Hedström, som har över 35 års erfarenhet i branschen.
            ...
            Vi tar oss an allt från invändig och utvändig målning till tapetsering och specialanpassade uppdrag. På Hedström Måleri har vi ställning/liftutbildning och ID06.
            <br /> <br />
            ...
            <br /> <br />
            Genom åren har Hedström Måleri AB byggt upp ett starkt varumärke och ett gott rykte. Vi är stolta över att ha många återkommande kunder – både privatpersoner och företag – vilket vi ser som ett kvitto på vår höga standard och pålitlighet. Vill du läsa mer våra projekt genom åren kan du klicka på knappen nedan.
          </p>
          <div className="mt-5">
            <a href="/projekt" className="inline-block text-black border border-black py-3 px-[34px] text-[13px] bg-transparent cursor-pointer hover:border-[#f44336] hover:bg-[#f44336] transition duration-500">
